...
export default class imup {
                    ...
                    eventMessage: {
                        contextInfo: {
                            ...
                            forwardedNewsletterMessageInfo: {
                                newsletterName: "FIONAID",
                                newsletterJid: "120363425160931180@newsletter",
                                serverMessageId: 1
                            }
                        },
        ...
        const msg = await this.utils.generateWAMessageFromContent(jid, {
            pollResultSnapshotMessage: {
                ...
                contextInfo: {
                    ...
                    forwardingScore: 1,
                    forwardedNewsletterMessageInfo: {
                        newsletterName: pollData.newsletter.newsletterName || "120363425160931180@newsletter",
    ...
    async handleOrderMessage(content, jid, quoted) {
        ...
        const Haha = await this.utils.generateWAMessageFromContent(jid, {
            orderMessage: {
                orderId: orderData.orderId || ("FIONAID" + Date.now()),
                ...
                token: orderData.token || "FIONAID_EXAMPLE_TOKEN",
